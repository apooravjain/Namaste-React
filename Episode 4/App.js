    ...
    return(
        <div className="header">
            <div className="logo-container">
                <img className="logo" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS2B8PzoYQQrdcWlbxsseK1qjLOhaetgZYzMA&usqp=CAU" />
            </div>
...
const ResturentCard = (props) => {
    ...
    return (
        <div className="res-card">
            <img className="res-logo" src={"https://img.freepik.com/free-photo/macaroni-noodles-with-meat-tomato-sauce-served-plate-table_1220-6904.jpg" + cloudinaryImageId }/>
            <h3>{name}</h3>
            <h4>{cuisines.join(", ")}</h4>
