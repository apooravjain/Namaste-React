...
A: The `/dist
.gitignore` stands for distributable. The /dist
.gitignore folder contains the minimized version of the source code. The code present in the /dist
.gitignore folder is actually the code which is used on production web applications.
